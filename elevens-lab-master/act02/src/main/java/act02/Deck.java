...
public class Deck {
   ...
   * Cards should be created by rank, then by suit.  For example if ranks has
   * 1 and 2 and suits has "clubs" and "hearts", then cards should be created in 
   * this order: 1 clubs, 1 hearts, 2 clubs, 2 hearts.  It must be done this
   * way for the test to pass!
	...
	/**
	 * Deals a card from this deck.  size is the index of the card that was
   * last dealt.  If size == 0 then we've dealt all the cards and should return
